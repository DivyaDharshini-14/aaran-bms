    ...
    <x-jet.authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div  class="space-y-5 bg-white">
                <x-input.login.floating type="email" name="email" :value="old('email')" label="Email"/>
                <x-input.login.floating type="password" name="password" :value="old('password')" label="Password"/>
            </div>
{{--            <div>--}}
